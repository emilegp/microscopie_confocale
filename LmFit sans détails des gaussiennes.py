...
# Données fournies : x_data et y_data contiennent les valeurs des points à ajuster
x_data = [
...
# Incertitudes : les tableaux contiennent les valeurs minimales et maximales d'incertitude
error_p = [
...
for i in range(len(x_data)):
    ...
    try:
        result = model.fit(y_data[i], params, x=x_data[i])  # Ajustement du modèle
