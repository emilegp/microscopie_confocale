...
%TODO
Le fonctionnement de base de la microscopie confocale par fluorescence repose sur l'utilisation d'un laser focalisé afin de balayer un échantillon marqué par des fluorophores, tout en éliminant, à l'aide d'un diaphrame optique nommé sténopé, les interférences provenant des plans non-focaux \textcolor{red}{(Source 1)}. En d'autres termes, 
...
Le rôle d'un sténopé dans un système optique est d'éliminer les faisceaux lumineux ne provenant pas du plan focal, permettant d'améliorer la définition et la netteté des images. Cependant, la taille de ce diaphrame est important dans le balancement de la résolution et de la quantité de lumière admise par le système. En effet, si la taille du sténopé est trop petite, la quantité de lumière provenant du plan focal lui-même est réduite, engendrant une perte de puissance. De plus, puisque la quantité de lumière atteignant le détecteur est réduite, le rapport entre le bruit et les signaux diminue, ce qui rend le bruit de fond plus apparent. De cette manière, les images peuvent apparaître moins définies et plus sombres \textcolor{red}{(Source 2)}.

**Quel serait le sténopé le plus petit que l’on pourrait utiliser avec un
système parfait utilisant un profil de faisceau gaussien et opérant à 600 nm?**

% Source 2 : Confocal Microscopy C Denis Semwogerere Eric R. Weeks. (Chrome Extension, je te l'enverrai quand tu vas être rendu aux sources) 
